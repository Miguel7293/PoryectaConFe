            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex  justify-between" v-if="$page.props.user.permissions.includes('create lessons')">
                        <Link :href="route('lessons.create')" class="text-white bg-indigo-500 hover-:bg-indigo-700 py-2 px-4 rounded" v-if="$page.props.user.permissions.includes('create lessons')">
                            CREATE LESSON
                        </Link>
                    </div>
                <div class="mt-4">
                    <ul role="list" class="divide-y divide-gray-100" v-for="lesson in lessons.data">
